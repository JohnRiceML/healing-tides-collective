...
- **[docs/BUILD-TRACKER.md](docs/BUILD-TRACKER.md)** — the single build tracker (keyed to the June-10 brief): what's shipped, what's left, what's blocked, plus the open decisions. Reconciled against live code.
