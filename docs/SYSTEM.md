...
| `/admin` | **Admin** overview + nav — ADMIN-gated (`requireAdmin`) + noindex | 🟢 Live (prod)¹ |
| `/admin/practitioners` | Practitioner list (read-only) — status / completeness / views / activity | 🟢 Live (prod)¹ |
